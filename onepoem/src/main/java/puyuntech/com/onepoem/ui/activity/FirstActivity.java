...
import puyuntech.com.onepoem.presenter.FirstPresenter;
import puyuntech.com.onepoem.ui.adapter.OneItemAdapter;
...
public class FirstActivity extends ActivityDirector {
    List data;
    ...
    public void setViewClickListener() {
        adapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                FirstPresenter.ShowType type = (FirstPresenter.ShowType) model.type;
                switch (type) {
                    case MVP:
...
//        initTitle("欢迎", false);
    ...
    public void showView() {
        //刷新界面
        refreshPage(REFRESH_FLAG, ((FirstPresenter) mPresenter).getData(), adapter, null, recycler_view);
