...
import puyuntech.com.onepoem.ui.activity.poem.PoemListFragment;

@ContentView(R.layout.fragment_main)
public class MainFragment extends FragmentDirector implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public static MainFragment instantiation(int position) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return PoemListFragment.instantiation(position);
        }
