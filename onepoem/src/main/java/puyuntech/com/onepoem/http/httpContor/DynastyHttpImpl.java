 ...
 * @描述 诗词相关接口
 **/
public class DynastyHttpImpl extends BaseHttpImpl implements DynastyHttp {

    private static DynastyHttpImpl mHttpImpl = new DynastyHttpImpl();//单例的接口处理类

    private DynastyHttpImpl() {
    }
     ...
     * @return
     */
    public static DynastyHttpImpl getMHttpImpl() {
        return mHttpImpl;
    }


    @Override
    public RequestParams getDynastyList(String id, String size, final HttpAfterExpand afterHttp) {
        //        if (isProxy()) {
        RequestParams params = new RequestParams(URLUtils.GET_DYNASTY_LIST);
