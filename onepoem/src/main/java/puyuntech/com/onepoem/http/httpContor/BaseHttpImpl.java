...
import puyuntech.com.onepoem.http.httpContor.base.HttpAfter;
import puyuntech.com.onepoem.R;
import puyuntech.com.onepoem.http.httpContor.base.BaseHttp;
...
//    public Context mContext;
    ...
    protected void showOtherErrorMsg(Result resultBean) {
        //错误码未知
        showToast("错误码未知:"+resultBean.getCode());
    }
