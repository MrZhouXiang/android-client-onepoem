...
import puyuntech.com.onepoem.model.MultipleItem;
import puyuntech.com.onepoem.model.MySection;
import puyuntech.com.onepoem.model.Status;
import puyuntech.com.onepoem.model.Video;
...
public class DataServer {
    ...
    public static List<MultipleItem> getMultipleItemData() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (i % 3 == 1) {
                str = "test";
                multipleItem.setItemType(MultipleItem.TEST);
            }
