...
/**
 * @作者 Administrator
 * @创建时间 2016-04-19 上午 9:56
 * @修改时间 2016-04-19 上午 9:56
 * @修改描述
 * @修改者 Administrator
 **/
...
//  }
    ...
    private static String getImageCacheDir() {
        String dir = Environment.getExternalStorageDirectory() + "/xiaoer/Image" + File.separator;
//        Environment.getExternalStorageDirectory() + "/xiaoer/Image" + Image + ".jpg";
